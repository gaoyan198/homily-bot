...
| [2026-08-06 · Patreon "MUST-READ: My Proven Method to Time Bottoms: Volatility Holes + Descending Blue Ribbon"](https://www.patreon.com/DannyTrades/posts/must-read-my-to-165903668) — the long form of the X post §5o mined | the ladder with numbers: **30% when the VH appears · +25% on a red candle · +25% when the longest momentum bar breaks · +20% on the blue→red ribbon reversal** | **UNVERIFIED** — surfaced only as a search-engine summary; the page is paywalled. Adopted as #165's frozen weights *because* they were not chosen by us; the owner can confirm or correct by pasting the text before #165 runs |
