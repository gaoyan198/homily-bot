...
| IPO↓ (discovery rows only) | the close sits below the name's first-sale reference (IPO offer / direct-listing ref / SPAC NAV, `ipo_ref.json`) | Danny's sourcing axis (#111, BACKTEST §26): below-IPO months beat baseline at 6m and 12m even on the 2021-wreck side (+41.9% vs +31.7%). **Survivorship caveat: this strategy's losers delist out of every backtest** — read it next to `F:n/3`, never as a buy signal, never an auto-add |
