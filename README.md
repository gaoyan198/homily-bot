...
(decayed volume-at-price point of control), nearest `res`istance shelf, and %
of chips in profit.
...
| `homily_danny.py` | Composite state machine: monthly trend × weekly circle × daily candle × chip context |
