...
trigger*, not a signal — #119 stays parked until the owner names a
target date or amount, and sells remain human forever (§9.1 is not
relaxed at any horizon). What the plan owes the owner meanwhile: the
